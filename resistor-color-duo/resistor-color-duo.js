...
/*
Take color names, output a number based on that color, add max of two colors up. Any colors after 2 will not be added together.
thinking:
map over the colors array and exract index value of the color(s) and add the index values together?
...
-----------------------------------------
OTHER NOTES FROM LESSONS PRACTICED:
const COLORS = [
	"black",
	"brown",
	"red",
